          ...
          {THEMES.map((t) => (
            ...
            >
              <div
                ...
                data-theme={t}
              >
                <div className="absolute inset-0 grid grid-cols-4 gap-1.5 p-1">
              ...
              <span className="text-[11px] capitalize font-medium truncate w-full text-center">
                {t}
              </span>
            </button>
          ))}
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
                  {PREVIEW_MESSAGES.map((message) => (
                    <div
                      key={message.id}
                      className={`flex ${message.isSent && "justify-end"}`}
                    >
                      <div
